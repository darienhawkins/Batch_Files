...
SET uncPath=%serverBase%\BannerProd\touchnet\Cashnet
SET sendMailFolder=_Tools\SendEmail
SET scriptFolder=scripts
SET archiveFolder=archive
SET processFolder=Process
SET winSCPArg=getchashnet_ftps.txt
SET appworXTarget=\\oldschedserver01\Appworx$\Prod\ARStudent\Touchnet
...
REM Copy file to archive folder
	copy %uncPath%\recon.remit_* %uncPath%\%archiveFolder%\ /y
...
REM Delete from folder
DEL %uncPath%\recon.remit_*
